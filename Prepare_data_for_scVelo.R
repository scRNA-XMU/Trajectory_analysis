...
load("/cluster/huanglab/hhuang/project/SingleCell-pipline/Trajectory/results/trajectory/covid_combined.nmat.Rdata") #就是一个matrix
load("/cluster/huanglab/hhuang/project/SingleCell-pipline/Trajectory/results/trajectory/covid_combined.emat.Rdata") #就是一个matrix
